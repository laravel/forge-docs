...
You may manually restart a daemon using `sudo -S supervisorctl restart daemon-ID:*`. This may also be done within the deployment script to reload the daemon after a new release is deployed.
