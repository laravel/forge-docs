...
For Amazon S3 in combination with an EC2 server, you can alternatively choose to the identity of the EC2 server to
stream the backup to S3. In this case, you do not need to provide the credentials, but instead you simply check
the "Use EC2 Assumed Role" checkbox.
